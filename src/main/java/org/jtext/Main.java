...
public class Main {
    ...
    private static void printHeader(final Curses curses, final ReadKey read) {
        ...
        curses.drawVerticalLineAt(0, 2, '|', curses.getScreenHeight() - 2);
